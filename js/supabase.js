...
const POSTS_SEED = [
  ...
  { id:"p17", title:"الوقاية من السكري: دليل عملي للأسرة العربية", slug:"diabetes-prevention-guide", excerpt:"ينتشر داء السكري بمعدلات مقلقة في العالم العربي. نقدم دليلاً علمياً بسيطاً حول أساليب الوقاية والتغذية السليمة.", content:"<p>يُعدّ داء السكري من أكثر الأمراض المزمنة انتشاراً في المجتمعات العربية، إذ تشير تقارير منظمة الصحة العالمية إلى أن ١ من كل ٦ بالغين مصاب أو في خطر مرتفع للإصابة. الغذاء الصحي والنشاط البدني يقلصان هذه المخاطر.</p>", section_id:"s4", featured_image_url:"https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800&q=80", author_id:"00000000-0000-0000-0000-000000000000", author_name:"صحة ورياضة", status:"published", is_featured:false, published_at:new Date(Date.now()-7*86400000).toISOString(), created_at:new Date(Date.now()-7*86400000).toISOString() },
  // ── تكنولوجيا ─────────────────────────────────────────
